...
const translations = {
  en: {
    ...
    'footer.vocabulary': 'Vocabulary Bank',
    'footer.speakingtopics': 'Speaking Topics',
  ...
  bn: {
    ...
    'footer.vocabulary': 'শব্দভাণ্ডার ব্যাংক',
    'footer.speakingtopics': 'স্পিকিং টপিক',
    'footer.freeresources': 'বিনামূল্যে সম্পদ',
